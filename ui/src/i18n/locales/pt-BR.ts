...
export const pt_BR: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.traversalai/traversalai.json com segurança.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando traversalai dashboard --no-open no desktop.",
    },
    insecure: {

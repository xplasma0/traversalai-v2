      ...
      <header class="topbar">
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img
                src=${basePath ? `${basePath}/traversalai-logo.jpg` : "/traversalai-logo.jpg"}
                alt="TraversalAI"
              />
            </div>
        ...
        <div class="topbar-status">
          <div class="pill">
            ...
            <span class="mono">${traversalVersion}</span>
          </div>
          <div class="pill">
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            <a
              ...
              href="https://xplasma0.github.io/traversalai-docs"

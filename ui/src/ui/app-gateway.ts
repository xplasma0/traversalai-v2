...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as TraversalAIApp);
      void loadAgents(host as unknown as TraversalAIApp);
      void loadToolsCatalog(host as unknown as TraversalAIApp);
      void loadNodes(host as unknown as TraversalAIApp, { quiet: true });
      void loadDevices(host as unknown as TraversalAIApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as TraversalAIApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as TraversalAIApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as TraversalAIApp);
  }
}

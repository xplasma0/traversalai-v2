---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with TraversalAI"
read_when:
  - You want Xiaomi MiMo models in TraversalAI
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). TraversalAI uses

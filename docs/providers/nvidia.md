---
summary: "Use NVIDIA's OpenAI-compatible API in TraversalAI"
read_when:
  - You want to use NVIDIA models in TraversalAI
...
traversalai onboard --auth-choice skip
traversalai models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```

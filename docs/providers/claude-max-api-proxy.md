...
You can point TraversalAI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or TraversalAI
...
- [Anthropic provider](/providers/anthropic) - Native TraversalAI integration with Claude setup-token or API keys

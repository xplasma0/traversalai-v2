---
summary: "Use Qianfan's unified API to access many models in TraversalAI"
read_when:
...
3. TraversalAI installed on your system
...
4. Copy the API key for use with TraversalAI

## CLI setup

```bash
traversalai onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [TraversalAI Configuration](/gateway/configuration)

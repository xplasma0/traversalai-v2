---
summary: "Use Qwen OAuth (free tier) in TraversalAI"
read_when:
  - You want to use Qwen with TraversalAI
...
If you already logged in with the Qwen Code CLI, TraversalAI will sync credentials

---
summary: "Use Synthetic's Anthropic-compatible API in TraversalAI"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. TraversalAI registers it as the
...
Note: TraversalAI's Anthropic client appends `/v1` to the base URL, so use

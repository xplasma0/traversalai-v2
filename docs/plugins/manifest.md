...
read_when:
  - You are building a TraversalAI plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (traversalai.plugin.json)

Every plugin **must** ship a `traversalai.plugin.json` file in the **plugin root**.
TraversalAI uses this manifest to validate configuration **without executing plugin

...
TraversalAI treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.traversalai/settings/voicewake.json`

Shape:

```json
{ "triggers": ["traversalai", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

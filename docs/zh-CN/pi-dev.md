...
本指南总结了在 TraversalAI 中开发 Pi 集成的合理工作流程。
...
状态存储在 TraversalAI 状态目录下。默认为 `~/.traversalai`。如果设置了 `TRAVERSALAI_STATE_DIR`，则使用该目录。

要重置所有内容：

- `traversalai.json` 用于配置
...
- https://docs.traversalai.ai/testing
- https://docs.traversalai.ai/start/getting-started

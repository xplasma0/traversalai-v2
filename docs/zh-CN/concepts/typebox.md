...
- 生成的 Swift 模型：`apps/macos/Sources/TraversalAIProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/traversalai/traversalai/main/dist/protocol.schema.json

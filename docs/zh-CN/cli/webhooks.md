---
read_when:
  - 你想将 Gmail Pub/Sub 事件接入 TraversalAI
  - 你需要 Webhook 辅助命令
summary: "`traversalai webhooks`（Webhook 辅助工具 + Gmail Pub/Sub）的 CLI 参考"
title: webhooks
x-i18n:
...
```bash
traversalai webhooks gmail setup --account you@example.com

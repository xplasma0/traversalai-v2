...
summary: "`traversalai skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
```bash
traversalai skills list
traversalai skills list --eligible
traversalai skills info <name>
traversalai skills check
```

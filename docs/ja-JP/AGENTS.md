...
- Use TraversalAI as the user-facing product name in translated docs when rebrand policy is active.
- Keep runtime compatibility identifiers (`traversalai`, config paths, command names) unless a migration task explicitly changes them.

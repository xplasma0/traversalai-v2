...
TraversalAI’s Gateway can serve an OpenResponses-compatible `POST /v1/responses` endpoint.
...
`traversalai agent`), so routing/permissions/config match your Gateway.

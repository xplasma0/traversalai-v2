...
- Install via CLI: `traversalai plugins install @traversalai/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `traversalai plugins install ./extensions/zalo`
   - From npm (if published): `traversalai plugins install @traversalai/zalo`
...
- Approve via:
  - `traversalai pairing list zalo`
  - `traversalai pairing approve zalo <CODE>`
...
- Example: `traversalai message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `traversalai channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `traversalai logs --follow`

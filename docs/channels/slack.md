...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure TraversalAI HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `traversalai pairing approve slack <code>`.
...
```bash
traversalai pairing list slack
```
...
TraversalAI supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, TraversalAI falls back to normal delivery for remaining payloads.

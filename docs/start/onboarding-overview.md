---
summary: "Overview of TraversalAI onboarding options and flows"
read_when:
...
TraversalAI supports multiple onboarding paths depending on where the Gateway runs
...
- [`traversalai onboard` command](/cli/onboard)

## macOS app onboarding

Use the TraversalAI app when you want a fully guided setup on macOS. Docs:

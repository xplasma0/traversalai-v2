...
TraversalAI ships three update channels:
...
When you **explicitly** switch channels with `--channel`, TraversalAI also aligns
the install method:
...
When you switch channels with `traversalai update`, TraversalAI also syncs plugin sources:

...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: TraversalAIPhotosLatestParams) async throws -> TraversalAIPhotosLatestPayload {
        ...
        var results: [TraversalAIPhotoPayload] = []
        ...
        return TraversalAIPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> TraversalAIPhotoPayload
    {
        ...
        return TraversalAIPhotoPayload(
            format: "jpeg",

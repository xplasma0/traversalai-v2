...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.traversalai.gateway"
    private static let nodeService = "ai.traversalai.node"
    private static let talkService = "ai.traversalai.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.traversalai.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.traversalai.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("traversalai-gateway.log")
    }

...
final class CalendarService: CalendarServicing {
    func events(params: TraversalAICalendarEventsParams) async throws -> TraversalAICalendarEventsPayload {
        ...
        let payload = selected.map { event in
            TraversalAICalendarEventPayload(
        ...
        return TraversalAICalendarEventsPayload(events: payload)
    }
    ...
    func add(params: TraversalAICalendarAddParams) async throws -> TraversalAICalendarAddPayload {
        ...
        let payload = TraversalAICalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return TraversalAICalendarAddPayload(event: payload)
    }

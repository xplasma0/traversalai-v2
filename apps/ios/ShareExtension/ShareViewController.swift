...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.traversalai.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to TraversalAI", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to TraversalAI gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to TraversalAI.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "TraversalAIShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "TraversalAI is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "TraversalAI Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("traversalai-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in

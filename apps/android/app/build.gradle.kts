...
android {
  namespace = "ai.traversalai.android"
  compileSdk = 36

  sourceSets {
    getByName("main") {
      assets.directories.add("../../shared/TraversalAIKit/Sources/TraversalAIKit/Resources")
    }
  }

  defaultConfig {
    applicationId = "ai.traversalai.android"
    minSdk = 31
    targetSdk = 36
  ...
  onVariants { variant ->
    variant.outputs
      ...
      .forEach { output ->
        ...
        val outputFileName = "traversalai-${versionName}-${buildType}.apk"

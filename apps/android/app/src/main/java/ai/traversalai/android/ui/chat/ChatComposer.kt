...
import ai.traversalai.android.ui.mobileSurface
import ai.traversalai.android.ui.mobileText
import ai.traversalai.android.ui.mobileTextSecondary
import ai.traversalai.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.traversalai.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.traversalai.android.ui.mobileFontFamily,

...
import ai.traversalai.android.voice.VoiceConversationRole
  ...
  Row(
    ...
    Surface(
      ...
      Column(
        ...
        Text(
          if (isUser) "You" else "TraversalAI",
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("TraversalAI is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}

...
public enum TraversalAICanvasA2UICommand: String, Codable, Sendable {
...
public struct TraversalAICanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct TraversalAICanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {

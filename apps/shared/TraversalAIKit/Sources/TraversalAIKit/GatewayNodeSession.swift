...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.traversalai", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.traversalai", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: TraversalAIProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {

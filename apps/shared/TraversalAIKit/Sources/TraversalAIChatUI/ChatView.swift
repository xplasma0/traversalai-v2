...
@MainActor
public struct TraversalAIChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: TraversalAIChatViewModel
    ...
    public init(
        viewModel: TraversalAIChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                TraversalAIChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [TraversalAIChatMessage] {
        let base: [TraversalAIChatMessage]
    ...
    private func mergeToolResults(in messages: [TraversalAIChatMessage]) -> [TraversalAIChatMessage] {
        ...
        for message in messages {
            ...
            let merged = TraversalAIChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: TraversalAIChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: TraversalAIChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: TraversalAIChatMessage) -> String {

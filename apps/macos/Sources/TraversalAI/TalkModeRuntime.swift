...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.traversalai", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.traversalai", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [TraversalAIChatMessage] = messages.compactMap { item in

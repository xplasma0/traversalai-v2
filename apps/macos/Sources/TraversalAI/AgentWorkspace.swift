...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.traversalai", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return TraversalAIConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - TraversalAI Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.traversalai/traversalai.json

...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = TraversalAIConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = TraversalAIConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = TraversalAIConfigFile.loadDict()
            ...
            TraversalAIConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/traversalai"
        state.remoteCliPath = ""
        return state
    }
}

...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .traversalaiSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? TraversalAIPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? TraversalAIPaths.stateDirURL.path
...
extension Notification.Name {
    static let traversalaiSelectSettingsTab = Notification.Name("traversalaiSelectSettingsTab")
}

...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.traversalai", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("TraversalAI/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__traversalai__/a2ui/").absoluteString + "?platform=macos"
    }

...
enum TraversalAIConfigFile {
    private static let logger = Logger(subsystem: "ai.traversalai", category: "config")
    ...
    static func stateDirURL() -> URL {
        TraversalAIPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        TraversalAIPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-traversalai-config-file",
            "event": "config.write",

...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.traversalai", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other TraversalAI windows, but below the system’s pop-up menus.

...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/traversalai/traversalai") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/traversalai/traversalai")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://traversalai.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "TraversalAIBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "TraversalAIBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "TraversalAIGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "TraversalAIGitCommit") as? String) ??
            "unknown"
    }

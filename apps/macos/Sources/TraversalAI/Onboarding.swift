...
enum UIStrings {
    static let welcomeTitle = "Welcome to TraversalAI"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "traversalai.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: TraversalAIChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g traversalai@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: TraversalAIChatViewModel(

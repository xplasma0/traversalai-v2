...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: TraversalAIProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": TraversalAIProtocol.AnyCodable("start"),
                "name": TraversalAIProtocol.AnyCodable("bash"),
            ],
            summary: nil)

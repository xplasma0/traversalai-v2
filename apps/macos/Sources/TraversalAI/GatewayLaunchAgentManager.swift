...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.traversalai", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".traversalai/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.traversalaiCommand(
            subcommand: "gateway",

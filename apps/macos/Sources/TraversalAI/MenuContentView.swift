...
/// Menu contents for the TraversalAI menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About TraversalAI") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "TraversalAI Not Configured"
        case .remote:
            "Remote TraversalAI Active"
        case .local:
            "TraversalAI Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .traversalaiSelectSettingsTab, object: tab)
        }
    }

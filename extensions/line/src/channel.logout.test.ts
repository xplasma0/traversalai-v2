import type { TraversalAIConfig, PluginRuntime, ResolvedLineAccount } from "traversalai/plugin-sdk";
...
async function runLogoutScenario(params: { cfg: TraversalAIConfig; accountId: string }): Promise<{

import type { LineChannelData, TraversalAIPluginApi, ReplyPayload } from "traversalai/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: TraversalAIPluginApi): void {
  api.registerCommand({
    name: "card",

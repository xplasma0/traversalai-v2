...
import { resolveChannelMediaMaxBytes, type TraversalAIConfig } from "traversalai/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: TraversalAIConfig; accountId?: string }): string[] {

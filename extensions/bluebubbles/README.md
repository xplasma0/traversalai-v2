...
This directory contains the **BlueBubbles external channel plugin** for TraversalAI.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `traversalai/plugin-sdk` helpers.

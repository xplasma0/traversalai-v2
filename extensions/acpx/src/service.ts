...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "traversalai/plugin-sdk";
import {
  ACPX_PINNED_VERSION,
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: TraversalAIPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: TraversalAIPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;

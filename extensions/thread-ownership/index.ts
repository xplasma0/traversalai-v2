import type { TraversalAIConfig, TraversalAIPluginApi } from "traversalai/plugin-sdk";
...
function resolveOwnershipAgent(config: TraversalAIConfig): { id: string; name: string } {

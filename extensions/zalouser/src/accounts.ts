...
export function listZalouserAccountIds(cfg: TraversalAIConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: TraversalAIConfig): string {
...
function mergeZalouserAccountConfig(cfg: TraversalAIConfig, accountId: string): ZalouserAccountConfig {

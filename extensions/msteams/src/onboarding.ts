...
function setMSTeamsDmPolicy(cfg: TraversalAIConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: TraversalAIConfig, allowFrom: string[]): TraversalAIConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,

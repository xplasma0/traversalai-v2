...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "traversalai/plugin-sdk";
...
import { resolvePreferredTraversalAITmpDir } from "../../../src/infra/tmp-traversalai-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredTraversalAITmpDir(), "msteams-mention-"));

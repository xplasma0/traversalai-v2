import type { ChannelOnboardingAdapter, TraversalAIConfig, WizardPrompter } from "traversalai/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.traversalai.ai/channels/mattermost",
    ].join("\n"),

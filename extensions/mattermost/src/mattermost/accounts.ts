...
export function listMattermostAccountIds(cfg: TraversalAIConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: TraversalAIConfig): string {
...
export function listEnabledMattermostAccounts(cfg: TraversalAIConfig): ResolvedMattermostAccount[] {

...
- Version alignment with core TraversalAI release numbers.
...
- First public release of the @traversalai/voice-call plugin.
...
- CLI: `traversalai voicecall` commands (call/start/continue/speak/end/status/tail/expose).

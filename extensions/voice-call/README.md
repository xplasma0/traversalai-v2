...
Official Voice Call plugin for **TraversalAI**.
...
Docs: `https://docs.traversalai.ai/plugins/voice-call`
Plugin system: `https://docs.traversalai.ai/plugin`

## Install (local dev)

### Option A: install via TraversalAI (recommended)
...
```bash
mkdir -p ~/.traversalai/extensions
cp -R extensions/voice-call ~/.traversalai/extensions/voice-call
cd ~/.traversalai/extensions/voice-call && pnpm install
```
...
```bash
traversalai voicecall call --to "+15555550123" --message "Hello from TraversalAI"
traversalai voicecall continue --call-id <id> --message "Any questions?"
traversalai voicecall speak --call-id <id> --message "One moment"
traversalai voicecall end --call-id <id>
traversalai voicecall status --call-id <id>
traversalai voicecall tail

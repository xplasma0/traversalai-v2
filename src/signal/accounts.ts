...
function mergeSignalAccountConfig(cfg: TraversalAIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: TraversalAIConfig): ResolvedSignalAccount[] {

...
describe("registerSlackInteractionEvents", () => {
          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "traversalai:verify" }],
            },
          ],
        },
      },
  ...
  it("falls back to container channel and message timestamps", async () => {
    ...
    await handler!({
      ...
      action: {
        type: "button",
        action_id: "traversalai:container",
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "traversalai:multi" }],
            },
          ],
        },
      },
  ...
  it("renders date/time/datetime picker selections in confirmation rows", async () => {
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "traversalai:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "traversalai:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "traversalai:datetime" }],
            },
          ],
        },
      },
    ...
    await handler!({
      ...
      action: {
        type: "datetimepicker",
        action_id: "traversalai:datetime",
        block_id: "datetime_block",
  ...
  it("captures workflow button trigger metadata", async () => {
    ...
    await handler!({
      ...
      action: {
        ...
        action_id: "traversalai:workflow",
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "traversalai:deploy_form",
          root_view_id: "VROOT",
    ...
    expect(payload).toMatchObject({
      ...
      actionId: "view:traversalai:deploy_form",
      callbackId: "traversalai:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("captures modal input labels and picker values across block types", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V400",
          callback_id: "traversalai:routing_form",
            ...
            values: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@traversalai.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://xplasma0.github.io/traversalai-docs",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expect(payload.inputs).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          inputKind: "email",
          inputEmail: "team@traversalai.ai",
        }),
        expect.objectContaining({
          actionId: "url_input",
          inputKind: "url",
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "traversalai:long_richtext",

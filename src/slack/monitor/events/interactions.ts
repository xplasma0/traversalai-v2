...
// Prefix for TraversalAI-generated action IDs to scope our handler
const TRAVERSALAI_ACTION_PREFIX = "traversalai:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${TRAVERSALAI_ACTION_PREFIX}`);

  // Handle TraversalAI modal submissions with callback_ids scoped by our prefix.

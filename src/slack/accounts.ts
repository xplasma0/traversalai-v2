...
function mergeSlackAccountConfig(cfg: TraversalAIConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: TraversalAIConfig): ResolvedSlackAccount[] {

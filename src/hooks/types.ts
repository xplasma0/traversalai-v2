...
export type TraversalAIHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "traversalai-bundled" | "traversalai-managed" | "traversalai-workspace" | "traversalai-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: TraversalAIHookMetadata;

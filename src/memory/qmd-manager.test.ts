...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: TraversalAIConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: TraversalAIConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__traversalaiMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__traversalaiMcporterColdStartWarned;
  });

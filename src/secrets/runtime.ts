...
type SecretDefaults = NonNullable<TraversalAIConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: TraversalAIConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveTraversalAIAgentDir()));

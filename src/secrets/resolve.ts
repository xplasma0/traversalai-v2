...
function resolveResolutionLimits(config: TraversalAIConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: TraversalAIConfig): SecretProviderConfig {

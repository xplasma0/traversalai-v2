...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@traversalai", { botUsername: "traversalai" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@traversalai args", {
        botUsername: "traversalai",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@traversalai: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "traversalai" })).toBe(
      "/help@otherbot",
    );
  });

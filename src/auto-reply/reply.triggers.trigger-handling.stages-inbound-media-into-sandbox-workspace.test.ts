...
describe("stageSandboxMedia", () => {
  it("stages allowed media and blocks unsafe paths", async () => {
    await withSandboxMediaTempHome("traversalai-triggers-", async (home) => {
      const cfg = createSandboxMediaStageConfig(home);
      const workspaceDir = join(home, "traversalai");
      ...
      {
        const inboundDir = join(home, ".traversalai", "media", "inbound");

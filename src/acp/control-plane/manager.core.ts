...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: TraversalAIConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: TraversalAIConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: TraversalAIConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: TraversalAIConfig }): Promise<void> {

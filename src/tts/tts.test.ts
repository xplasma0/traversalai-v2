...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.TRAVERSALAI_TTS_PREFS;
      process.env.TRAVERSALAI_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.TRAVERSALAI_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: TraversalAIConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,

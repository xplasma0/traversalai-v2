import type { TraversalAIConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
import { resolveAgentConfig } from "./agent-scope.js";

const DEFAULT_ACK_REACTION = "👀";

function resolveDefaultMessagePrefix(): string {
  return process.env.TRAVERSALAI_APP === "1" ? "[traversalai]" : "[traversalai]";
}
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? resolveDefaultMessagePrefix();
}

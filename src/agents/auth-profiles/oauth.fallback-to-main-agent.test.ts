...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveTraversalAIAgentDir() returns mainAgentDir
    process.env.TRAVERSALAI_STATE_DIR = tmpDir;
    process.env.TRAVERSALAI_AGENT_DIR = mainAgentDir;

...
function resolveWatchPaths(workspaceDir: string, config?: TraversalAIConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: TraversalAIConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: TraversalAIConfig }) {

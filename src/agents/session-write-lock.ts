...
const CLEANUP_STATE_KEY = Symbol.for("traversalai.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("traversalai.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("traversalai.sessionWriteLockWatchdogState");

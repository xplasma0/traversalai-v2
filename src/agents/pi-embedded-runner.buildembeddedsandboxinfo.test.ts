...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/traversalai-sandbox",
    agentWorkspaceDir: "/tmp/traversalai-workspace",
    workspaceAccess: "none",
    containerName: "traversalai-sbx-test",
    ...
    browser: {
      ...
      containerName: "traversalai-sbx-browser-test",
    },

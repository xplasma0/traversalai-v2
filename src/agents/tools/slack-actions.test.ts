...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): TraversalAIConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: TraversalAIConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: TraversalAIConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();

...
export function resolveSessionToolsVisibility(cfg: TraversalAIConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: TraversalAIConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: TraversalAIConfig): AgentToAgentPolicy {

...
function resolveMemoryToolContext(options: { config?: TraversalAIConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: TraversalAIConfig): MemoryCitationsMode {

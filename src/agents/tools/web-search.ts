...
type WebSearchConfig = NonNullable<TraversalAIConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: TraversalAIConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("traversalai configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://xplasma0.github.io/traversalai-docs/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://traversalai.ai",
          "X-Title": "TraversalAI Web Search",
        },

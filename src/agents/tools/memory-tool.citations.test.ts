...
function asTraversalAIConfig(config: Partial<TraversalAIConfig>): TraversalAIConfig {
  return config as TraversalAIConfig;
}

function createToolConfig() {
  return asTraversalAIConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: TraversalAIConfig = createToolConfig()) {

...
type TraversalAIReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: TraversalAIReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createTraversalAIReadTool(base, {
...
export function createTraversalAIReadTool(
  base: AnyAgentTool,
  options?: TraversalAIReadToolOptions,
): AnyAgentTool {

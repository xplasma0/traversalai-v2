...
export const DEFAULT_SANDBOX_IMAGE = "traversalai-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "traversalai-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "traversalai-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "traversalai-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "traversalai-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "traversalai-sandbox-browser";

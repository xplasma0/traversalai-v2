...
function resolveAvatarSource(cfg: TraversalAIConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: TraversalAIConfig, agentId: string): AgentAvatarResolution {

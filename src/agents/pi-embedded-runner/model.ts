...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveTraversalAIAgentDir();
 ...
 * a hint.
 *
 * See: https://github.com/traversalai/traversalai/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "traversalai configure". ' +
    "See: https://xplasma0.github.io/traversalai-docs/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "traversalai configure". ' +
    "See: https://xplasma0.github.io/traversalai-docs/providers/vllm",
};

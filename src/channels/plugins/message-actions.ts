...
export function listChannelMessageActions(cfg: TraversalAIConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: TraversalAIConfig): boolean {
...
export function supportsChannelMessageCards(cfg: TraversalAIConfig): boolean {

...
export type ChannelOnboardingDmPolicy = {
  ...
  policyKey: string;
  allowFromKey: string;
  getCurrent: (cfg: TraversalAIConfig) => DmPolicy;
  setPolicy: (cfg: TraversalAIConfig, policy: DmPolicy) => TraversalAIConfig;
...
export type ChannelOnboardingAdapter = {
  ...
  disable?: (cfg: TraversalAIConfig) => TraversalAIConfig;
};

...
export type ChannelAgentToolFactory = (params: { cfg?: TraversalAIConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: TraversalAIConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: TraversalAIConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: TraversalAIConfig }) => boolean;
  supportsCards?: (params: { cfg: TraversalAIConfig }) => boolean;

...
function makeCfg(overrides?: Partial<TraversalAIConfig>): TraversalAIConfig {
  return {
    bindings: [],
    channels: {},
    ...overrides,
...
describe("resolveWhatsAppHeartbeatRecipients", () => {
  ...
  function resolveWith(
    cfgOverrides: Partial<TraversalAIConfig> = {},
  ...
  it("ignores session store when session scope is global", () => {
    ...
    const result = resolveWith({
      session: { scope: "global" } as TraversalAIConfig["session"],

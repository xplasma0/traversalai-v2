...
export const A2UI_PATH = "/__traversalai__/a2ui";

export const CANVAS_HOST_PATH = "/__traversalai__/canvas";

export const CANVAS_WS_PATH = "/__traversalai__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.traversalaiCanvasA2UIAction.postMessage(...)
  // - Android: window.traversalaiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["traversalaiCanvasA2UIAction"];
  ...
  globalThis.TraversalAI = globalThis.TraversalAI ?? {};
  globalThis.TraversalAI.postMessage = postToNode;
  globalThis.TraversalAI.sendUserAction = sendUserAction;
  globalThis.traversalaiPostMessage = postToNode;
  globalThis.traversalaiSendUserAction = sendUserAction;

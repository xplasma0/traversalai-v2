...
export function listWhatsAppAuthDirs(cfg: TraversalAIConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: TraversalAIConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: TraversalAIConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: TraversalAIConfig): ResolvedWhatsAppAccount[] {

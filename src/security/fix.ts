...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof TraversalAIConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: TraversalAIConfig; env: NodeJS.ProcessEnv }): {
  cfg: TraversalAIConfig;
  changes: string[];
  policyFlips: Set<string>;
} {

...
import { type TraversalAIConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: TraversalAIConfig): string[] {
...
export function listAgentsForGateway(cfg: TraversalAIConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: TraversalAIConfig): string {
...
function resolveSessionStoreAgentId(cfg: TraversalAIConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: TraversalAIConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: TraversalAIConfig): GatewaySessionsDefaults {

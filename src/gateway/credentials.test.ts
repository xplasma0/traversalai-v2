...
function cfg(input: Partial<TraversalAIConfig>): TraversalAIConfig {
  return input as TraversalAIConfig;
}

type ResolveFromConfigInput = Parameters<typeof resolveGatewayCredentialsFromConfig>[0];
type GatewayConfig = NonNullable<TraversalAIConfig["gateway"]>;
...
const DEFAULT_GATEWAY_ENV = {
  TRAVERSALAI_GATEWAY_TOKEN: "env-token",
  TRAVERSALAI_GATEWAY_PASSWORD: "env-password",

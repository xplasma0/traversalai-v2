...
function mergeIMessageAccountConfig(cfg: TraversalAIConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: TraversalAIConfig): ResolvedIMessageAccount[] {

...
export type ConfigSchema = ReturnType<typeof TraversalAISchema.toJSONSchema>;
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const hints = applyDerivedTags(mapSensitivePaths(TraversalAISchema, "", buildBaseHints()));
  const next = {

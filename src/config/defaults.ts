...
function resolveAnthropicDefaultAuthMode(cfg: TraversalAIConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyTalkApiKey(config: TraversalAIConfig): TraversalAIConfig {
...
export function applyTalkConfigNormalization(config: TraversalAIConfig): TraversalAIConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: TraversalAIConfig): TraversalAIConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyLoggingDefaults(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyContextPruningDefaults(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyCompactionDefaults(cfg: TraversalAIConfig): TraversalAIConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }

...
function mergeDiscordAccountConfig(cfg: TraversalAIConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: TraversalAIConfig): ResolvedDiscordAccount[] {

...
export function listBindings(cfg: TraversalAIConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: TraversalAIConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: TraversalAIConfig) {

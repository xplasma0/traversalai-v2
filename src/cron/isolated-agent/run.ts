...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/traversalai/traversalai/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.TRAVERSALAI_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.traversalai/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: TraversalAIConfig = {
    ...params.cfg,

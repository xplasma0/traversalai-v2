...
import {
  probeAuthenticatedTraversalAIRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated traversalai relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedTraversalAIRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-traversalai-relay-token",

...
function resolveDefaultAccountId(cfg: TraversalAIConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: TraversalAIConfig): boolean {
...
export function summarizeBindings(cfg: TraversalAIConfig, bindings: AgentBinding[]): string[] {

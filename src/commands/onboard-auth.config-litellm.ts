...
export function applyLitellmProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyLitellmConfig(cfg: TraversalAIConfig): TraversalAIConfig {

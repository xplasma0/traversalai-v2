...
export function applyOpenrouterProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyMoonshotConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: TraversalAIConfig): TraversalAIConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: TraversalAIConfig): TraversalAIConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: TraversalAIConfig): TraversalAIConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: TraversalAIConfig): TraversalAIConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: TraversalAIConfig): TraversalAIConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyQianfanProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: TraversalAIConfig): TraversalAIConfig {

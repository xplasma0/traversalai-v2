...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://xplasma0.github.io/traversalai-docs/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("traversalai hooks list")}`,
      `  ${formatCliCommand("traversalai hooks enable <name>")}`,
      `  ${formatCliCommand("traversalai hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );

...
const ensureTraversalAIModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveTraversalAIAgentDir = vi.fn().mockReturnValue("/tmp/traversalai-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/traversalai-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureTraversalAIModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveTraversalAIAgentDir,
}));

...
export function applyVercelAiGatewayProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyVercelAiGatewayConfig(cfg: TraversalAIConfig): TraversalAIConfig {

...
export function applyMinimaxProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyMinimaxConfig(cfg: TraversalAIConfig): TraversalAIConfig {

...
export function applyOpencodeZenProviderConfig(cfg: TraversalAIConfig): TraversalAIConfig {
...
export function applyOpencodeZenConfig(cfg: TraversalAIConfig): TraversalAIConfig {

...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.TRAVERSALAI_STATE_DIR = "/tmp/traversalai-cli-state";
    process.env.TRAVERSALAI_CONFIG_PATH = "/tmp/traversalai-cli-state/traversalai.json";
    delete process.env.TRAVERSALAI_GATEWAY_PORT;
    delete process.env.TRAVERSALAI_PROFILE;
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        TRAVERSALAI_STATE_DIR: "/tmp/traversalai-daemon-state",
        TRAVERSALAI_CONFIG_PATH: "/tmp/traversalai-daemon-state/traversalai.json",
        TRAVERSALAI_GATEWAY_PORT: "19001",
      },
      sourcePath: "/tmp/ai.traversalai.gateway.plist",
    });

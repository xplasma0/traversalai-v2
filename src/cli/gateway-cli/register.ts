      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["traversalai gateway run", "Run the gateway in the foreground."],
            ["traversalai gateway status", "Show service status and probe reachability."],
            ["traversalai gateway discover", "Find local and wide-area gateway beacons."],
            ["traversalai gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "xplasma0.github.io/traversalai-docs/cli/gateway")}\n`,
      ),
  );

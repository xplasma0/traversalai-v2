    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["traversalai directory self --channel slack", "Show the connected account identity."],
          [
            'traversalai directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["traversalai directory groups list --channel discord", "List available groups/channels."],
          [
            "traversalai directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "xplasma0.github.io/traversalai-docs/cli/directory",
        )}\n`,
    )
    .action(() => {

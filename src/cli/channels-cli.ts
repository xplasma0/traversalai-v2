    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["traversalai channels list", "List configured channels and auth profiles."],
          ["traversalai channels status --probe", "Run channel status checks and probes."],
          [
            "traversalai channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["traversalai channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "xplasma0.github.io/traversalai-docs/cli/channels",
        )}\n`,
    );

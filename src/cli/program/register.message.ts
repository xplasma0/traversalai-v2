...
${formatHelpExamples([
  ['traversalai message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'traversalai message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'traversalai message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "xplasma0.github.io/traversalai-docs/cli/message")}`,
    )
    .action(() => {

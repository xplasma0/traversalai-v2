...
export const normalizePluginsConfig = (
  config?: TraversalAIConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: TraversalAIConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: TraversalAIConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: TraversalAIConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }

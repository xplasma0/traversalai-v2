...
export type TraversalAIPluginConfigSchema = {
...
export type TraversalAIPluginToolContext = {
...
export type TraversalAIPluginToolFactory = (
  ctx: TraversalAIPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type TraversalAIPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type TraversalAIPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<TraversalAIConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type TraversalAIPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current TraversalAI configuration */
  config: TraversalAIConfig;
 ...
 */
export type TraversalAIPluginCommandDefinition = {
...
export type TraversalAIPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type TraversalAIPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type TraversalAIPluginCliContext = {
  program: Command;
  config: TraversalAIConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type TraversalAIPluginCliRegistrar = (ctx: TraversalAIPluginCliContext) => void | Promise<void>;

export type TraversalAIPluginServiceContext = {
  config: TraversalAIConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type TraversalAIPluginService = {
  id: string;
  start: (ctx: TraversalAIPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: TraversalAIPluginServiceContext) => void | Promise<void>;
};

export type TraversalAIPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type TraversalAIPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: TraversalAIPluginConfigSchema;
  register?: (api: TraversalAIPluginApi) => void | Promise<void>;
  activate?: (api: TraversalAIPluginApi) => void | Promise<void>;
};

export type TraversalAIPluginModule =
  | TraversalAIPluginDefinition
  | ((api: TraversalAIPluginApi) => void | Promise<void>);

export type TraversalAIPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | TraversalAIPluginToolFactory,
    opts?: TraversalAIPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: TraversalAIPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: TraversalAIPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: TraversalAIPluginHttpRouteHandler }) => void;
  registerChannel: (registration: TraversalAIPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: TraversalAIPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: TraversalAIPluginService) => void;
   ...
   */
  registerCommand: (command: TraversalAIPluginCommandDefinition) => void;

...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/traversalai/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/traversalai/extensions",
        global: "/Users/x/.traversalai/extensions",
        workspace: "/Users/x/ws/.traversalai/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.traversalai/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/traversalai/extensions",
        global: "/Users/x/.traversalai/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.traversalai/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/traversalai/extensions",
        global: "/Users/x/.traversalai/extensions",

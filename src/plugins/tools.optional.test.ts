...
const loadTraversalAIPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadTraversalAIPlugins: (params: unknown) => loadTraversalAIPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadTraversalAIPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadTraversalAIPluginsMock.mockClear();
  });

...
import {
  ...
  type TraversalAIPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @traversalai/voice-call -> voice-call).
...
export function discoverTraversalAIPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".traversalai", "extensions")];

...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.traversalai.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", TRAVERSALAI_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.traversalai.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://xplasma0.github.io/traversalai-docs/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when TRAVERSALAI_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.traversalai.gateway.plist",
    },
    {
      name: "uses profile-specific label when TRAVERSALAI_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", TRAVERSALAI_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.traversalai.jbphoenix.plist",
    },
    {
      name: "prefers TRAVERSALAI_LAUNCHD_LABEL over TRAVERSALAI_PROFILE",
      env: {
        HOME: "/Users/test",
        TRAVERSALAI_PROFILE: "jbphoenix",
        TRAVERSALAI_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from TRAVERSALAI_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        TRAVERSALAI_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty TRAVERSALAI_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        TRAVERSALAI_PROFILE: "myprofile",
        TRAVERSALAI_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.traversalai.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {

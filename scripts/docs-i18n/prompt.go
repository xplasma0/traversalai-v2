...
- Keep product names in English: TraversalAI, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the TraversalAI Gateway, use “Gateway 网关”.

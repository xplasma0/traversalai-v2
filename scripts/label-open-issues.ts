...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "traversalai", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for TraversalAI. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("TraversalAI Issue Label Audit");

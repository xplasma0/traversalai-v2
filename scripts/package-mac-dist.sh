...
#
# Output:
# - dist/TraversalAI.app
# - dist/TraversalAI-<version>.zip
# - dist/TraversalAI-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.traversalai.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/TraversalAI.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/TraversalAI-$VERSION.zip"
DMG="$ROOT_DIR/dist/TraversalAI-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/TraversalAI-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/TraversalAI-$VERSION.dSYM.zip"

...
if [[ -z "$version_content" ]]; then
  echo "<h2>TraversalAI $VERSION</h2>"
  echo "<p>Latest TraversalAI update.</p>"
  echo "<p><a href=\"https://github.com/traversalai/traversalai/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi

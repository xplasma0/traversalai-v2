...
show_usage() {
    cat << EOF
clawlog - TraversalAI Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View TraversalAI logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    TraversalAI logs flow through the macOS unified log (subsystem: ai.traversalai).
